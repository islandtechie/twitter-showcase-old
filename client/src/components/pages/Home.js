...
class Home extends Component {
    ...
    render() {
        if (this.state.searchText) return <Redirect to='/user-search'/>;
        return(
                    ...
                    <div className="tweet">
                        ...
                        <div className="tweet__body">
                            ...
                            <div className="tweet_body_text">
                                ...
                                <Search placeHolder="@elonmusk or 'bananas" setSearchText={this.state.setSearchText} inputID="user-search"/>
                            </div>
                        </div>
                    </div>
                    <div className="tweet">
